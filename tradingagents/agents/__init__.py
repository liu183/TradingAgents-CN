...
_EXPORTS: Dict[str, Tuple[str, str]] = {
    ...
    "create_hotspot_analyst": ("tradingagents.agents.analysts.hotspot_analyst", "create_hotspot_analyst"),
    "create_industry_chain_analyst": ("tradingagents.agents.analysts.industry_chain_analyst", "create_industry_chain_analyst"),
